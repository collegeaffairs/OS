//  OS Practical 8: e) Implementation of Preemptive Priority scheduling
#include <iostream>
using namespace std;
...
void printPDetialTable(int mat[][7], int totalProcesses,  int uptoColumn=7)
{
...
void calculate_time(int mat[][7], int totalProcesses)
{
    ...
    for(int time=0; processesCompleted!=totalProcesses; time++)
    {
        ...
        burst[highestPriorityIndex]--;
        if(burst[highestPriorityIndex]==0)
        {
            processesCompleted++;
...
int main()
{
	...
	printPDetialTable(mat, totalProcesses, 7);
